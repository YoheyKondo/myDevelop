...
namespace Proxies\__CG__\Plugin\Securitychecker4\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Config extends \Plugin\Securitychecker4\Entity\Config implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\Securitychecker4\\Entity\\Config' . "\0" . 'id', '' . "\0" . 'Plugin\\Securitychecker4\\Entity\\Config' . "\0" . 'check_result', '' . "\0" . 'Plugin\\Securitychecker4\\Entity\\Config' . "\0" . 'create_date', '' . "\0" . 'Plugin\\Securitychecker4\\Entity\\Config' . "\0" . 'update_date'];
        }
