...
// Returns the public 'Eccube\Controller\Admin\Product\TagController' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Eccube\\Controller\\Admin\\Product\\TagController.php';

$this->services['Eccube\\Controller\\Admin\\Product\\TagController'] = $instance = new \Eccube\Controller\Admin\Product\TagController(${($_ = isset($this->services['Eccube\\Repository\\TagRepository']) ? $this->services['Eccube\\Repository\\TagRepository'] : $this->load('getTagRepositoryService.php')) && false ?: '_'});
