...
// Returns the public 'Eccube\Controller\Admin\Setting\Shop\PaymentController' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Eccube\\Controller\\Admin\\Setting\\Shop\\PaymentController.php';

$this->services['Eccube\\Controller\\Admin\\Setting\\Shop\\PaymentController'] = $instance = new \Eccube\Controller\Admin\Setting\Shop\PaymentController(${($_ = isset($this->services['Eccube\\Repository\\PaymentRepository']) ? $this->services['Eccube\\Repository\\PaymentRepository'] : $this->load('getPaymentRepositoryService.php')) && false ?: '_'});
