...
// Returns the public 'Eccube\Controller\Admin\Content\MaintenanceController' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Eccube\\Controller\\Admin\\Content\\MaintenanceController.php';

$this->services['Eccube\\Controller\\Admin\\Content\\MaintenanceController'] = $instance = new \Eccube\Controller\Admin\Content\MaintenanceController(${($_ = isset($this->services['Eccube\\Service\\SystemService']) ? $this->services['Eccube\\Service\\SystemService'] : $this->load('getSystemServiceService.php')) && false ?: '_'});
