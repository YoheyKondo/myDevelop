...
// Returns the public 'Eccube\Controller\Admin\Setting\Shop\MailController' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Eccube\\Controller\\Admin\\Setting\\Shop\\MailController.php';

$this->services['Eccube\\Controller\\Admin\\Setting\\Shop\\MailController'] = $instance = new \Eccube\Controller\Admin\Setting\Shop\MailController(${($_ = isset($this->services['Eccube\\Repository\\MailTemplateRepository']) ? $this->services['Eccube\\Repository\\MailTemplateRepository'] : $this->load('getMailTemplateRepositoryService.php')) && false ?: '_'});
