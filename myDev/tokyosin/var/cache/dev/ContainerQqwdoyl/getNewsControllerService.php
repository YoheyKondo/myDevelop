...
// Returns the public 'Eccube\Controller\Admin\Content\NewsController' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Eccube\\Controller\\Admin\\Content\\NewsController.php';

$this->services['Eccube\\Controller\\Admin\\Content\\NewsController'] = $instance = new \Eccube\Controller\Admin\Content\NewsController(${($_ = isset($this->services['Eccube\\Repository\\NewsRepository']) ? $this->services['Eccube\\Repository\\NewsRepository'] : $this->load('getNewsRepositoryService.php')) && false ?: '_'});
