...
// Returns the public 'Eccube\Controller\Admin\Customer\CustomerDeliveryEditController' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Eccube\\Controller\\Admin\\Customer\\CustomerDeliveryEditController.php';

$this->services['Eccube\\Controller\\Admin\\Customer\\CustomerDeliveryEditController'] = $instance = new \Eccube\Controller\Admin\Customer\CustomerDeliveryEditController(${($_ = isset($this->services['Eccube\\Repository\\CustomerAddressRepository']) ? $this->services['Eccube\\Repository\\CustomerAddressRepository'] : $this->load('getCustomerAddressRepositoryService.php')) && false ?: '_'});
