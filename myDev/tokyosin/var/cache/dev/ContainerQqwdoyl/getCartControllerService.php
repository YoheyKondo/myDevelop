...
include_once $this->targetDirs[3].'\\src\\Eccube\\Controller\\Block\\CartController.php';

$this->services['Eccube\\Controller\\Block\\CartController'] = $instance = new \Eccube\Controller\Block\CartController(${($_ = isset($this->services['Eccube\\Service\\CartService']) ? $this->services['Eccube\\Service\\CartService'] : $this->getCartServiceService()) && false ?: '_'});
