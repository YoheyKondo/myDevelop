 ...
 */
class EccubeDevProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/secrity')) {
            // admin_login
            if ('/secrity/login' === $pathinfo) {
            ...
            if (0 === strpos($pathinfo, '/secrity/s')) {
                // admin_homepage_sale
                if ('/secrity/sale_chart' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/secrity/se')) {
                    // admin_homepage_nonstock
                    if ('/secrity/search_nonstock' === $pathinfo) {
                    ...
                    if ('/secrity/search_customer' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/secrity/setting/shop')) {
                        // admin_setting_shop_csv
                        if (0 === strpos($pathinfo, '/secrity/setting/shop/csv') && preg_match('#^/secrity/setting/shop/csv(?:/(?P<id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/secrity/setting/shop/delivery')) {
                            // admin_setting_shop_delivery
                            if ('/secrity/setting/shop/delivery' === $pathinfo) {
                            ...
                            if ('/secrity/setting/shop/delivery/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/secrity/setting/shop/delivery/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/secrity/setting/shop/delivery/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/secrity/setting/shop/delivery/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/secrity/setting/shop/delivery/sort_no/move' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/secrity/setting/shop/mail')) {
                            // admin_setting_shop_mail
                            if ('/secrity/setting/shop/mail' === $pathinfo) {
                            ...
                            if (preg_match('#^/secrity/setting/shop/mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/secrity/setting/shop/mail/preview' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/secrity/setting/shop/payment')) {
                            // admin_setting_shop_payment
                            if ('/secrity/setting/shop/payment' === $pathinfo) {
                            ...
                            if ('/secrity/setting/shop/payment/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/secrity/setting/shop/payment/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/secrity/setting/shop/payment/image/add' === $pathinfo) {
                            ...
                            if (preg_match('#^/secrity/setting/shop/payment/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/secrity/setting/shop/payment/(?P<id>\\d+)/visible$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/secrity/setting/shop/payment/sort_no/move' === $pathinfo) {
                        ...
                        // admin_setting_shop
                        if ('/secrity/setting/shop' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/secrity/setting/shop/tax')) {
                            // admin_setting_shop_tax
                            if ('/secrity/setting/shop/tax' === $pathinfo) {
                            ...
                            if ('/secrity/setting/shop/tax/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/secrity/setting/shop/tax/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/secrity/setting/system')) {
                        // admin_setting_system_authority
                        if ('/secrity/setting/system/authority' === $pathinfo) {
                        ...
                        if ('/secrity/setting/system/log' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/secrity/setting/system/masterdata')) {
                            // admin_setting_system_masterdata
                            if ('/secrity/setting/system/masterdata' === $pathinfo) {
                            ...
                            if (preg_match('#^/secrity/setting/system/masterdata/(?P<entity>[^/]++)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/secrity/setting/system/masterdata/edit' === $pathinfo) {
                        ...
                        elseif (0 === strpos($pathinfo, '/secrity/setting/system/member')) {
                            // admin_setting_system_member
                            if ('/secrity/setting/system/member' === $pathinfo) {
                            ...
                            if ('/secrity/setting/system/member/new' === $pathinfo) {
                            ...
                            if (preg_match('#^/secrity/setting/system/member/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/secrity/setting/system/member/(?P<id>\\d+)/up$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/secrity/setting/system/member/(?P<id>\\d+)/down$#sD', $pathinfo, $matches)) {
                            ...
                            if (preg_match('#^/secrity/setting/system/member/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/secrity/setting/system/security' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/secrity/setting/system/system')) {
                            // admin_setting_system_system
                            if ('/secrity/setting/system/system' === $pathinfo) {
                            ...
                            if ('/secrity/setting/system/system/phpinfo' === $pathinfo) {
                ...
                elseif (0 === strpos($pathinfo, '/secrity/shipping')) {
                    // admin_shipping_update_order_status
                    if (preg_match('#^/secrity/shipping/(?P<id>\\d+)/order_status$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/secrity/shipping/(?P<id>\\d+)/tracking_number$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_shipping_edit
                    if (preg_match('#^/secrity/shipping/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/secrity/shipping/preview_notify_mail') && preg_match('#^/secrity/shipping/preview_notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (0 === strpos($pathinfo, '/secrity/shipping/notify_mail') && preg_match('#^/secrity/shipping/notify_mail/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/secrity/store/plugin')) {
                    if (0 === strpos($pathinfo, '/secrity/store/plugin/api')) {
                        if (0 === strpos($pathinfo, '/secrity/store/plugin/api/search')) {
                            // admin_store_plugin_owners_search
                            if ('/secrity/store/plugin/api/search' === $pathinfo) {
                            ...
                            if (0 === strpos($pathinfo, '/secrity/store/plugin/api/search/page') && preg_match('#^/secrity/store/plugin/api/search/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/secrity/store/plugin/api/schema_update' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/secrity/store/plugin/api/install')) {
                            // admin_store_plugin_install_confirm
                            if (preg_match('#^/secrity/store/plugin/api/install/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                            ...
                            if ('/secrity/store/plugin/api/install' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/secrity/store/plugin/api/delete') && preg_match('#^/secrity/store/plugin/api/delete/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                        ...
                        if (0 === strpos($pathinfo, '/secrity/store/plugin/api/upgrade')) {
                            // admin_store_plugin_api_upgrade
                            if ('/secrity/store/plugin/api/upgrade' === $pathinfo) {
                            ...
                            if (preg_match('#^/secrity/store/plugin/api/upgrade/(?P<id>\\d+)/confirm$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/secrity/store/plugin/api/update' === $pathinfo) {
                    ...
                    // admin_store_plugin
                    if ('/secrity/store/plugin' === $pathinfo) {
                    ...
                    if (preg_match('#^/secrity/store/plugin/(?P<id>\\d+)/update$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/secrity/store/plugin/(?P<id>\\d+)/enable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/secrity/store/plugin/(?P<id>\\d+)/disable$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/secrity/store/plugin/(?P<id>\\d+)/uninstall$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/secrity/store/plugin/install' === $pathinfo) {
                    ...
                    if ('/secrity/store/plugin/authentication_setting' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/secrity/store/plugin/Securitychecker4/config')) {
                        // securitychecker4_admin_config
                        if ('/secrity/store/plugin/Securitychecker4/config' === $pathinfo) {
                            $ret = array (  '_controller' => 'Plugin\\Securitychecker4\\Controller\\ConfigController::index',  '_route' => 'securitychecker4_admin_config',);
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            if (!isset($requiredSchemes[$context->getScheme()])) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_securitychecker4_admin_config;
                                }

                                return array_replace($ret, $this->redirect($rawPathinfo, 'securitychecker4_admin_config', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_securitychecker4_admin_config:

                        // securitychecker4_admin_config_check
                        if ('/secrity/store/plugin/Securitychecker4/config/check' === $pathinfo) {
                            $ret = array (  '_controller' => 'Plugin\\Securitychecker4\\Controller\\ConfigController::check',  '_route' => 'securitychecker4_admin_config_check',);
                            $requiredSchemes = array (  'https' => 0,  'http' => 1,);
                            $hasRequiredScheme = isset($requiredSchemes[$context->getScheme()]);
                            if (!in_array($requestMethod, ['POST'])) {
                                if ($hasRequiredScheme) {
                                ...
                                goto not_securitychecker4_admin_config_check;
                            }
                            if (!$hasRequiredScheme) {
                                if ('GET' !== $canonicalMethod) {
                                    goto not_securitychecker4_admin_config_check;
                                ...
                                return array_replace($ret, $this->redirect($rawPathinfo, 'securitychecker4_admin_config_check', key($requiredSchemes)));
                            }

                            return $ret;
                        }
                        not_securitychecker4_admin_config_check:

                    }

                }

                elseif (0 === strpos($pathinfo, '/secrity/store/template')) {
                    // admin_store_template
                    if ('/secrity/store/template' === $pathinfo) {
                    ...
                    if (preg_match('#^/secrity/store/template/(?P<id>\\d+)/download$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/secrity/store/template/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/secrity/store/template/install' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/secrity/c')) {
                // admin_change_password
                if ('/secrity/change_password' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/secrity/content')) {
                    if (0 === strpos($pathinfo, '/secrity/content/block')) {
                        // admin_content_block
                        if ('/secrity/content/block' === $pathinfo) {
                        ...
                        if ('/secrity/content/block/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/secrity/content/block/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/secrity/content/block/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_content_cache
                    if ('/secrity/content/cache' === $pathinfo) {
                    ...
                    // admin_content_css
                    if ('/secrity/content/css' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/secrity/content/file_')) {
                        // admin_content_file
                        if ('/secrity/content/file_manager' === $pathinfo) {
                        ...
                        if ('/secrity/content/file_view' === $pathinfo) {
                        ...
                        if ('/secrity/content/file_delete' === $pathinfo) {
                        ...
                        if ('/secrity/content/file_download' === $pathinfo) {
                    ...
                    // admin_content_js
                    if ('/secrity/content/js' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/secrity/content/layout')) {
                        // admin_content_layout
                        if ('/secrity/content/layout' === $pathinfo) {
                        ...
                        if (preg_match('#^/secrity/content/layout/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/secrity/content/layout/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/secrity/content/layout/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/secrity/content/layout/view_block' === $pathinfo) {
                        ...
                        if (preg_match('#^/secrity/content/layout/(?P<id>\\d+)/preview$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/secrity/content/maintenance' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/secrity/content/news')) {
                        // admin_content_news
                        if ('/secrity/content/news' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/secrity/content/news/page') && preg_match('#^/secrity/content/news/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/secrity/content/news/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/secrity/content/news/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/secrity/content/news/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    elseif (0 === strpos($pathinfo, '/secrity/content/page')) {
                        // admin_content_page
                        if ('/secrity/content/page' === $pathinfo) {
                        ...
                        if ('/secrity/content/page/new' === $pathinfo) {
                        ...
                        if (preg_match('#^/secrity/content/page/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/secrity/content/page/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                ...
                elseif (0 === strpos($pathinfo, '/secrity/customer')) {
                    // admin_customer
                    if ('/secrity/customer' === $pathinfo) {
                    ...
                    // admin_customer_page
                    if (0 === strpos($pathinfo, '/secrity/customer/page') && preg_match('#^/secrity/customer/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/secrity/customer/(?P<id>\\d+)/resend$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/secrity/customer/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/secrity/customer/export' === $pathinfo) {
                    ...
                    if (preg_match('#^/secrity/customer/(?P<id>\\d+)/delivery/new$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/secrity/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/secrity/customer/(?P<id>\\d+)/delivery/(?P<did>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    // admin_customer_new
                    if ('/secrity/customer/new' === $pathinfo) {
                    ...
                    // admin_customer_edit
                    if (preg_match('#^/secrity/customer/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
            ...
            elseif (0 === strpos($pathinfo, '/secrity/order')) {
                // admin_shipping_csv_import
                if ('/secrity/order/shipping_csv_upload' === $pathinfo) {
                ...
                if ('/secrity/order/csv_template' === $pathinfo) {
                ...
                // admin_order_edit
                if (preg_match('#^/secrity/order/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/secrity/order/search')) {
                    if (0 === strpos($pathinfo, '/secrity/order/search/customer/html')) {
                        // admin_order_search_customer_html
                        if ('/secrity/order/search/customer/html' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/secrity/order/search/customer/html/page') && preg_match('#^/secrity/order/search/customer/html/page(?:/(?P<page_no>[^/]++))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/secrity/order/search/customer/id' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/secrity/order/search/product')) {
                        // admin_order_search_product
                        if ('/secrity/order/search/product' === $pathinfo) {
                        ...
                        if (0 === strpos($pathinfo, '/secrity/order/search/product/page') && preg_match('#^/secrity/order/search/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/secrity/order/search/order_item_type' === $pathinfo) {
                ...
                // admin_order_mail
                if (preg_match('#^/secrity/order/(?P<id>\\d+)/mail$#sD', $pathinfo, $matches)) {
                ...
                if ('/secrity/order/mail/view' === $pathinfo) {
                ...
                // admin_order_page
                if (0 === strpos($pathinfo, '/secrity/order/page') && preg_match('#^/secrity/order/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if ('/secrity/order/bulk_delete' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/secrity/order/export')) {
                    // admin_order_export_order
                    if ('/secrity/order/export/order' === $pathinfo) {
                    ...
                    if ('/secrity/order/export/shipping' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/secrity/order/export/pdf')) {
                        // admin_order_export_pdf
                        if ('/secrity/order/export/pdf' === $pathinfo) {
                        ...
                        if ('/secrity/order/export/pdf/download' === $pathinfo) {
            ...
            elseif (0 === strpos($pathinfo, '/secrity/product')) {
                if (0 === strpos($pathinfo, '/secrity/product/c')) {
                    if (0 === strpos($pathinfo, '/secrity/product/category')) {
                        // admin_product_category
                        if ('/secrity/product/category' === $pathinfo) {
                        ...
                        if (preg_match('#^/secrity/product/category(?:/(?P<parent_id>\\d+))?$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/secrity/product/category/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/secrity/product/category/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/secrity/product/category/sort_no/move' === $pathinfo) {
                        ...
                        if ('/secrity/product/category/export' === $pathinfo) {
                        ...
                        if ('/secrity/product/category_csv_upload' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/secrity/product/class_category')) {
                        // admin_product_class_category
                        if (preg_match('#^/secrity/product/class_category/(?P<class_name_id>\\d+)$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/secrity/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/secrity/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/secrity/product/class_category/(?P<class_name_id>\\d+)/(?P<id>\\d+)/visibility$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/secrity/product/class_category/sort_no/move' === $pathinfo) {
                    ...
                    elseif (0 === strpos($pathinfo, '/secrity/product/class_name')) {
                        // admin_product_class_name
                        if ('/secrity/product/class_name' === $pathinfo) {
                        ...
                        if (preg_match('#^/secrity/product/class_name/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                        ...
                        if (preg_match('#^/secrity/product/class_name/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                        ...
                        if ('/secrity/product/class_name/sort_no/move' === $pathinfo) {
                    ...
                    if (0 === strpos($pathinfo, '/secrity/product/csv_template') && preg_match('#^/secrity/product/csv_template/(?P<type>\\w+)$#sD', $pathinfo, $matches)) {
                ...
                if ('/secrity/product/product_csv_upload' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/secrity/product/product/class')) {
                    // admin_product_product_class
                    if (preg_match('#^/secrity/product/product/class/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/secrity/product/product/class/(?P<id>\\d+)/clear$#sD', $pathinfo, $matches)) {
                ...
                // admin_product_page
                if (0 === strpos($pathinfo, '/secrity/product/page') && preg_match('#^/secrity/product/page(?:/(?P<page_no>\\d+))?$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/secrity/product/product')) {
                    // admin_product_image_add
                    if ('/secrity/product/product/image/add' === $pathinfo) {
                    ...
                    if ('/secrity/product/product/new' === $pathinfo) {
                    ...
                    if (preg_match('#^/secrity/product/product/(?P<id>\\d+)/edit$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/secrity/product/product/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/secrity/product/product/(?P<id>\\d+)/copy$#sD', $pathinfo, $matches)) {
                    ...
                    if (preg_match('#^/secrity/product/product/(?P<id>\\d+)/display$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/secrity/product/classes') && preg_match('#^/secrity/product/classes/(?P<id>\\d+)/load$#sD', $pathinfo, $matches)) {
                ...
                if ('/secrity/product/export' === $pathinfo) {
                ...
                if (0 === strpos($pathinfo, '/secrity/product/bulk/product-status') && preg_match('#^/secrity/product/bulk/product\\-status/(?P<id>\\d+)$#sD', $pathinfo, $matches)) {
                ...
                if (0 === strpos($pathinfo, '/secrity/product/tag')) {
                    // admin_product_tag
                    if ('/secrity/product/tag' === $pathinfo) {
                    ...
                    if (preg_match('#^/secrity/product/tag/(?P<id>\\d+)/delete$#sD', $pathinfo, $matches)) {
                    ...
                    if ('/secrity/product/tag/sort_no/move' === $pathinfo) {
