...
// Returns the public 'Eccube\Controller\Block\SearchProductController' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Eccube\\Controller\\Block\\SearchProductController.php';

$this->services['Eccube\\Controller\\Block\\SearchProductController'] = $instance = new \Eccube\Controller\Block\SearchProductController(${($_ = isset($this->services['request_stack']) ? $this->services['request_stack'] : ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())) && false ?: '_'});
