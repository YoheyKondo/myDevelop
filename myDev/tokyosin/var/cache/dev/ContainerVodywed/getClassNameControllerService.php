...
// Returns the public 'Eccube\Controller\Admin\Product\ClassNameController' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Eccube\\Controller\\Admin\\Product\\ClassNameController.php';

$this->services['Eccube\\Controller\\Admin\\Product\\ClassNameController'] = $instance = new \Eccube\Controller\Admin\Product\ClassNameController(${($_ = isset($this->services['Eccube\\Repository\\ClassNameRepository']) ? $this->services['Eccube\\Repository\\ClassNameRepository'] : $this->load('getClassNameRepositoryService.php')) && false ?: '_'});
